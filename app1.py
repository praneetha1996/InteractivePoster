...
def create_poster():
    ...
    my_poster.add_section(title="Data Analysis Plot",
        pyLDA={"filename":"code3.html", "height":"10in", "width":"15in", "caption": "This interactive plot is used for analysing the MIMIC3 dataset and find interesting facts from the data using tableau desktop."})
